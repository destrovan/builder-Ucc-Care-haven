...
export default function ConfidentialReport({
  isAnonymous = false,
}: ConfidentialReportProps) {
  const [urgency, setUrgency] = useState("");
  const [description, setDescription] = useState("");
  const [isSubmitted, setIsSubmitted] = useState(false);
  const [trackingId] = useState(
    "UCC-CARE-" + Math.random().toString(36).substr(2, 9).toUpperCase(),
  );
        ...
        <div className="container mx-auto px-4 py-8 max-w-2xl">
          <Card className="border-success/20">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Your confidential support request has been received and will be
                reviewed by our professional counseling team.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="bg-muted/30 rounded-lg p-4">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Save this ID to check your report status and view counselor
                  responses. Keep it private and secure.
                </p>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        A qualified counselor will review your request within 24
                        hours (or immediately for urgent cases).
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        You'll receive an initial response with guidance and
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Continue the conversation and receive professional
                        guidance through our secure platform.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>If this is an emergency:</strong> Contact Campus
                  Security immediately at (XXX) XXX-XXXX or call 988 (Suicide &
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-calm-blue/20 to-trust-teal/20">
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <Alert className="mb-6 border-primary/20 bg-primary/5">
          ...
          <AlertDescription>
            <strong>Your privacy is protected.</strong> This form is
            confidential and secure.
            {isAnonymous
              ? " No personal information is required."
              : " Your information is only shared with qualified counselors."}
          </AlertDescription>
        </Alert>
        ...
        <Alert className="mb-6 border-warning/20 bg-warning/5">
          ...
          <AlertDescription>
            ...
            Campus Security at (XXX) XXX-XXXX or 988 (Crisis Lifeline) for
            immediate help.
          </AlertDescription>
        </Alert>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Share what's on your mind. Our trained counselors are here to help
              and support you through any challenges you're facing.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Be as detailed as you feel comfortable. The more information
                  you provide, the better we can support you.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-2">
                  ...
                  >
                    I understand that this information will be reviewed by
                    qualified mental health professionals at UCC. I consent to
                    receiving support and guidance through this platform.
                    {!isAnonymous &&
                      " I understand that my identity will be kept confidential and only shared with my assigned counselor."}
                  </Label>
                </div>
              </div>
              ...
              <p className="text-center text-xs text-muted-foreground">
                After submission, you'll receive a unique tracking ID to check
                your report status and view counselor responses.
              </p>
            </form>
          </CardContent>
        </Card>
