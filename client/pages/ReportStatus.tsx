  ...
  const mockReportData = {
    ...
    updates: [
      ...
      },
      {
        ...
        type: "assigned",
        message:
          "Your case has been assigned to a qualified counselor who will review your situation.",
      },
      {
        id: "3",
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-calm-blue/20 to-trust-teal/20">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Alert className="mb-6 border-primary/20 bg-primary/5">
          ...
          <AlertDescription>
            Your tracking ID keeps your report confidential and secure. Never
        ...
        <Card className="mb-8">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Enter your unique tracking ID to view the status of your
          ...
          <CardContent>
            <form onSubmit={handleSearch} className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Your tracking ID was provided when you submitted your support
                  request
                </p>
              </div>
            </form>
            ...
            <div className="mt-6 p-4 bg-muted/30 rounded-lg">
              <p className="text-sm text-muted-foreground mb-2">
                <strong>Demo:</strong> Try using tracking ID:{" "}
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Track the progress of your confidential support request
                    </CardDescription>
                  </div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <Badge
                          className={getPriorityColor(reportData.priority)}
                        >
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm mt-1">
                        {formatDate(reportData.lastUpdate)}
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Your counselor will continue to work with you through
                        this platform. Check back regularly for updates and
                        responses.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        If you need to provide additional information or have
                        questions, you can submit a follow-up request
                        referencing this tracking ID.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Your tracking ID was displayed after submitting your support
                  request. If you didn't save it, you may need to submit a new
                  request.
                </p>
                <Link to="/report">
                  <Button variant="outline" size="sm">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  If you're in immediate danger or need crisis support, contact
