  ...
  const cases = [
    {
      ...
      description:
        "Experiencing severe anxiety about upcoming exams and having panic attacks...",
    ...
    },
    {
      ...
      description:
        "Struggling with depression and social isolation since starting college...",
      counselor: "Dr. Sarah Chen",
      isAnonymous: false,
    },
    {
      ...
      description:
        "Needed support with stress management techniques for academic workload...",
      counselor: "Dr. Sarah Chen",
      isAnonymous: false,
    },
  ];
  ...
  const updates = [
    {
      ...
      content:
        "Discussed coping strategies and provided resources for managing social anxiety. Student responded well to cognitive behavioral techniques.",
    ...
    },
    {
      ...
      author: "Dr. Sarah Chen",
      content:
        "Private note: Student shows signs of improvement but may need longer-term support. Consider referring to group therapy sessions.",
                      ...
                      <div className="space-y-3 max-h-64 overflow-y-auto">
                        {updates
                          ...
                          .map((update) => (
                            <div
                              key={update.id}
                              className="p-3 bg-amber-50 border-l-4 border-amber-400 rounded"
                            >
                              <div className="flex items-center justify-between mb-2">
                                <span className="text-sm font-medium">
                                  {update.author}
